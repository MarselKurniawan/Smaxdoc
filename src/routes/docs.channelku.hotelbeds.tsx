...
export const Route = createFileRoute("/docs/channelku/hotelbeds")({
  head: () => ({
    meta: [
      { title: "Hotelbeds — Channelku | SinergiMax" },
      { name: "description", content: "Kelola koneksi Hotelbeds, pemetaan, sinkronisasi, dan konfigurasi." },
    ],
  }),
  component: Page,
});
...
const toc: TocItem[] = [
  ...
  { id: "accessing", label: "Mengakses Pengaturan Hotelbeds" },
  { id: "information", label: "Informasi Hotelbeds" },
...
function Page() {
  return (
    <DocsLayout product="Channelku" sidebar={channelkuSidebar} toc={toc} breadcrumb="Hotelbeds" activeTo="/docs/channelku/channel-manager/control-panel/hotelbeds">
      <h1 className="text-4xl font-bold tracking-[-0.04em]">Hotelbeds</h1>
      <p className="mt-4">
        <strong>Hotelbeds</strong> adalah sebuah OTA yang dapat diintegrasikan dengan Channel Manager. Melalui integrasi ini,
      ...
      <p className="mt-2">
        Setelah integrasi dikonfigurasi sepenuhnya, semua reservasi dari Hotelbeds akan muncul di <strong>Daftar Reservasi</strong>,
        memungkinkan Anda mengelolanya secara efisien di satu tempat.
      </p>

      {/* ==================== ACCESSING ==================== */}
      <Section id="accessing" title="Mengakses Pengaturan Hotelbeds">
        <p>Berikut cara mengakses pengaturan Hotelbeds:</p>
        <ol className="ml-6 list-decimal space-y-1">
          ...
          <li>Pilih <strong>Hotelbeds</strong> dari daftar saluran, atau Anda dapat mencari dari daftar dengan mengetik nama OTA.</li>
        </ol>
        <Figure label=""
        src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777337797/access-hotelbeds.png" />
      </Section>

      {/* ==================== INFORMATION ==================== */}
      <Section id="information" title="Informasi Hotelbeds">
        <p>
          Bagian ini memberikan panduan umum untuk menghubungkan properti Anda ke Hotelbeds.
        ...
        <Figure label=""
        src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777337825/hotelbeds-information-v1.png" />
      </Section>

      {/* ==================== USERNAME ==================== */}
      <Section id="username" title="Nama Pengguna">
        <p>
          Tab <strong>Nama Pengguna</strong> digunakan untuk melihat atau memperbarui kredensial yang diperlukan untuk terhubung dengan Hotelbeds.
        </p>

        <h4 className="mt-4 font-medium">Cara Memperbarui Kredensial:</h4>
        <ul className="ml-6 list-disc space-y-1">
          <li>Buka tab <strong>Nama Pengguna</strong>. Masukkan <strong>Nama Pengguna</strong>, <strong>Kata Sandi</strong>, atau <strong>Hotel ID</strong> yang ditetapkan untuk properti Anda oleh Hotelbeds.</li>
                  <Figure label=""
                  src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777337847/hotelbeds-username-v1.png" />
          ...
          <dl className="mt-2 space-y-2 text-sm">
            <div>
              ...
              <dd className="ml-4 text-muted-foreground">
                Pastikan semua bidang (<strong>Nama Pengguna</strong>, <strong>Kata Sandi</strong>, <strong>Hotel ID</strong>) valid dan disalin dengan benar dari Hotelbeds.
      ...
      <Section id="mapping" title="Pemetaan">
        <p>
          Fitur <strong>Pemetaan</strong> digunakan untuk menautkan kamar dan rate plan internal Anda dengan kamar dan rate plan yang sesuai dari Hotelbeds.
      ...
      <Section id="settings" title="Pengaturan">
        <p>
          Tab <strong>Pengaturan</strong> mengontrol bagaimana sistem Anda berinteraksi dengan Hotelbeds,
          termasuk sinkronisasi data dan penanganan reservasi.
        </p>

        <h4 className="mt-4 font-medium">Cara Mengonfigurasi Pengaturan:</h4>
                <Figure label=""
                src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777337868/setting-hotelbeds-v1.png" />
        <p>Untuk mengubah parameter Hotelbeds, buka tab <strong>Pengaturan</strong>. Bagian ini berisi beberapa opsi yang dapat dikonfigurasi:</p>
        <ul className="ml-6 list-disc space-y-1">
          <li>
            <strong>Aktifkan Saluran:</strong> Aktifkan opsi ini untuk mengaktifkan koneksi antara properti dan Hotelbeds.
          </li>
          <li>
            <strong>Aktifkan Pembaruan:</strong> Nyalakan opsi ini untuk mengizinkan sistem mendorong pembaruan harga, ketersediaan, dan pembatasan ke Hotelbeds.
          </li>
          <li>
            <strong>Aktifkan Reservasi:</strong> Aktifkan opsi ini untuk menerima pemesanan dari Hotelbeds.
          </li>
          <li>
          ...
          <li>
            <strong>Bagian Mata Uang (jika Berbeda):</strong> Pilih mata uang jika berbeda dari default sistem. Masukkan nilai konversi dan klik tombol <strong>simpan (✓)</strong> untuk menerapkan perubahan.
                  ...
                  <Figure label=""
                  src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777337991/set-hotelbeds-currency.png" />
          <li>
        ...
        <div className="mt-4 rounded-lg border bg-muted/50 p-4">
          ...
          <dl className="mt-2 space-y-2 text-sm">
            ...
            <div>
              <dt className="font-medium">Tidak menerima reservasi dari Hotelbeds</dt>
              <dd className="ml-4 text-muted-foreground">
                Konfirmasikan bahwa <strong>Aktifkan Reservasi</strong> diaktifkan. Pastikan rate plan dipetakan dan aktif di Hotelbeds dan sistem.
              </dd>
            </div>
            <div>
            ...
            <div>
              <dt className="font-medium">Impor Reservasi Hotelbeds Mendatang tidak berfungsi</dt>
              <dd className="ml-4 text-muted-foreground">
                Segarkan halaman dan klik lagi. Jika tidak ada reservasi yang diimpor, periksa dengan Hotelbeds apakah ada pemesanan baru dan telah dikonfirmasi.
              </dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="ml-4 text-muted-foreground">
                Arahkan kursor ke entri pembaruan yang gagal untuk melihat pesan kesalahan. Konfirmasikan bahwa rate plan dan kamar masih aktif di extranet Hotelbeds. Coba kirim ulang pembaruan menggunakan tombol <strong>Pembaruan OTA</strong>.
              </dd>
            </div>
          </dl>
        </div>
      ...
      <Section id="manual-ota-update" title="Pembaruan OTA Manual">
        <p>Gunakan fitur ini untuk secara manual mendorong pembaruan ke Hotelbeds.</p>
