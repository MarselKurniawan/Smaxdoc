...
export const Route = createFileRoute("/docs/channelku/pelican")({
  head: () => ({
    meta: [
      { title: "Pelican — Channelku | SinergiMax" },
      { name: "description", content: "Kelola koneksi Pelican, pemetaan, sinkronisasi, dan konfigurasi." },
    ],
  }),
  component: Page,
});
...
const toc: TocItem[] = [
  ...
  { id: "accessing", label: "Mengakses Pengaturan Pelican" },
  { id: "information", label: "Informasi Pelican" },
...
function Page() {
  return (
    <DocsLayout product="Channelku" sidebar={channelkuSidebar} toc={toc} breadcrumb="Pelican" activeTo="/docs/channelku/channel-manager/control-panel/pelican">
      <h1 className="text-4xl font-bold tracking-[-0.04em]">Pelican</h1>
      <p className="mt-4">
        <strong>Pelican</strong> adalah sebuah <strong>Property Management System (PMS)</strong> yang dapat diintegrasikan dengan Channel Manager. Melalui integrasi ini,
      ...
      <p className="mt-2">
        Setelah integrasi dikonfigurasi sepenuhnya, semua reservasi dari Pelican akan muncul di <strong>Daftar Reservasi</strong>,
        memungkinkan Anda mengelolanya secara efisien di satu tempat.
      </p>

      {/* ==================== ACCESSING ==================== */}
      <Section id="accessing" title="Mengakses Pengaturan Pelican">
        <p>Berikut cara mengakses pengaturan Pelican:</p>
        <ol className="ml-6 list-decimal space-y-1">
          ...
          <li>Pilih <strong>Pelican</strong> dari daftar saluran, atau Anda dapat mencari dari daftar dengan mengetik nama PMS.</li>
        </ol>
        <Figure label=""
        src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777450802/access-pelican.png" />
      </Section>

      {/* ==================== INFORMATION ==================== */}
      <Section id="information" title="Informasi Pelican">
        <p>
          Bagian ini memberikan panduan umum untuk menghubungkan properti Anda ke Pelican.
        ...
        <Figure label=""
        src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777450898/pelican-information-v1.png" />
      </Section>

      {/* ==================== USERNAME ==================== */}
      <Section id="username" title="Nama Pengguna">
        <p>
          Tab <strong>Nama Pengguna</strong> digunakan untuk melihat atau memperbarui kredensial yang diperlukan untuk terhubung dengan Pelican.
        </p>

        <h4 className="mt-4 font-medium">Cara Memperbarui Kredensial:</h4>
        <ul className="ml-6 list-disc space-y-1">
          <li>Buka tab <strong>Nama Pengguna</strong>. Masukkan <strong>Hotel ID</strong> yang ditetapkan untuk properti Anda oleh Pelican.</li>
                    <Figure label=""
                    src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777450842/pelican-credentials-v1.png" />
          ...
          <dl className="mt-2 space-y-2 text-sm">
            <div>
              ...
              <dd className="ml-4 text-muted-foreground">
                Pastikan semua bidang <strong>Hotel ID</strong> valid dan disalin dengan benar dari Pelican.
      ...
      <Section id="mapping" title="Pemetaan">
        <p>
          Fitur <strong>Pemetaan</strong> digunakan untuk menautkan kamar dan rate plan internal Anda dengan kamar dan rate plan yang sesuai dari Pelican.
      ...
      <Section id="settings" title="Pengaturan">
        <p>
          Tab <strong>Pengaturan</strong> mengontrol bagaimana sistem Anda berinteraksi dengan Pelican,
          termasuk sinkronisasi data dan penanganan reservasi.
        </p>

        <h4 className="mt-4 font-medium">Cara Mengonfigurasi Pengaturan:</h4>
                  <Figure label=""
                  src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777421278/Pelican-setting-v1.png" />
        <p>Untuk mengubah parameter Pelican, buka tab <strong>Pengaturan</strong>. Bagian ini berisi beberapa opsi yang dapat dikonfigurasi:</p>
        <ul className="ml-6 list-disc space-y-1">
          <li>
            <strong>Aktifkan Saluran:</strong> Aktifkan opsi ini untuk mengaktifkan koneksi antara properti dan Pelican.
          </li>
          <li>
            <strong>Aktifkan Pembaruan:</strong> Nyalakan opsi ini untuk mengizinkan sistem mendorong pembaruan harga, ketersediaan, dan pembatasan ke Pelican.
          </li>
          <li>
            <strong>Aktifkan Reservasi:</strong> Aktifkan opsi ini untuk menerima pemesanan dari Pelican.
          </li>
          <li>
          ...
          <li>
            <strong>Bagian Mata Uang (jika Berbeda):</strong> Pilih mata uang jika berbeda dari default sistem. Masukkan nilai konversi dan klik tombol <strong>simpan (✓)</strong> untuk menerapkan perubahan.
                    ...
                    <Figure label=""
                    src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777421327/set-Pelican-currency-v1.png" />
          <li>
        ...
        <div className="mt-4 rounded-lg border bg-muted/50 p-4">
          ...
          <dl className="mt-2 space-y-2 text-sm">
            ...
            <div>
              <dt className="font-medium">Tidak menerima reservasi dari Pelican</dt>
              <dd className="ml-4 text-muted-foreground">
                Konfirmasikan bahwa <strong>Aktifkan Reservasi</strong> diaktifkan. Pastikan rate plan dipetakan dan aktif di Pelican dan sistem.
              </dd>
            </div>
            <div>
            ...
            <div>
              <dt className="font-medium">Impor Reservasi Pelican Mendatang tidak berfungsi</dt>
              <dd className="ml-4 text-muted-foreground">
                Segarkan halaman dan klik lagi. Jika tidak ada reservasi yang diimpor, periksa dengan Pelican apakah ada pemesanan baru dan telah dikonfirmasi.
              </dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="ml-4 text-muted-foreground">
                Arahkan kursor ke entri pembaruan yang gagal untuk melihat pesan kesalahan. Konfirmasikan bahwa rate plan dan kamar masih aktif di extranet Pelican. Coba kirim ulang pembaruan menggunakan tombol <strong>Pembaruan OTA</strong>.
              </dd>
            </div>
          </dl>
        </div>
      ...
      <Section id="manual-ota-update" title="Pembaruan OTA Manual">
        <p>Gunakan fitur ini untuk secara manual mendorong pembaruan ke Pelican.</p>
