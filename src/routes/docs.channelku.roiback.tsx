...
export const Route = createFileRoute("/docs/channelku/roiback")({
  head: () => ({
    meta: [
      { title: "Roiback — Channelku | SinergiMax" },
      { name: "description", content: "Kelola koneksi Roiback, pemetaan, sinkronisasi, dan konfigurasi." },
    ],
  }),
  component: Page,
});
...
const toc: TocItem[] = [
  ...
  { id: "accessing", label: "Mengakses Pengaturan Roiback" },
  { id: "information", label: "Informasi Roiback" },
...
function Page() {
  return (
    <DocsLayout product="Channelku" sidebar={channelkuSidebar} toc={toc} breadcrumb="Roiback" activeTo="/docs/channelku/channel-manager/control-panel/roiback">
      <h1 className="text-4xl font-bold tracking-[-0.04em]">Roiback</h1>
      <p className="mt-4">
        <strong>Roiback</strong> adalah sebuah <strong>Internet Booking Engine (IBE)</strong> yang dapat diintegrasikan dengan Channel Manager. Melalui integrasi ini,
      ...
      <p className="mt-2">
        Setelah integrasi dikonfigurasi sepenuhnya, semua reservasi dari Roiback akan muncul di <strong>Daftar Reservasi</strong>,
        memungkinkan Anda mengelolanya secara efisien di satu tempat.
      </p>

      {/* ==================== ACCESSING ==================== */}
      <Section id="accessing" title="Mengakses Pengaturan Roiback">
        <p>Berikut cara mengakses pengaturan Roiback:</p>
        <ol className="ml-6 list-decimal space-y-1">
          ...
          <li>Pilih <strong>Roiback</strong> dari daftar saluran, atau Anda dapat mencari dari daftar dengan mengetik nama OTA.</li>
        </ol>
        <Figure label=""
        src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777257546/roiback_access.png" />
      </Section>

      {/* ==================== INFORMATION ==================== */}
      <Section id="information" title="Informasi Roiback">
        <p>
          Bagian ini memberikan panduan umum untuk menghubungkan properti Anda ke Roiback.
        ...
        <Figure label=""
        src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777253489/roiback_information_v1.png" />
      </Section>

      {/* ==================== USERNAME ==================== */}
      <Section id="username" title="Nama Pengguna">
        <p>
          Tab <strong>Nama Pengguna</strong> digunakan untuk melihat atau memperbarui kredensial yang diperlukan untuk terhubung dengan Roiback.
        </p>

        <h4 className="mt-4 font-medium">Cara Memperbarui Kredensial:</h4>
        <ul className="ml-6 list-disc space-y-1">
          <li>Buka tab <strong>Nama Pengguna</strong>. Masukkan <strong>Hotel ID</strong> yang ditetapkan untuk properti Anda oleh Roiback.</li>
                    <Figure label=""
                    src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777253651/roiback_credentials_v1.png" />
          ...
          <dl className="mt-2 space-y-2 text-sm">
            <div>
              ...
              <dd className="ml-4 text-muted-foreground">
                Pastikan <strong>Hotel ID</strong> valid dan disalin dengan benar dari Roiback.
      ...
      <Section id="mapping" title="Pemetaan">
        <p>
          Fitur <strong>Pemetaan</strong> digunakan untuk menautkan kamar dan rate plan internal Anda dengan kamar dan rate plan yang sesuai dari Roiback.
      ...
      <Section id="settings" title="Pengaturan">
        <p>
          Tab <strong>Pengaturan</strong> mengontrol bagaimana sistem Anda berinteraksi dengan Roiback,
          termasuk sinkronisasi data dan penanganan reservasi.
        </p>

        <h4 className="mt-4 font-medium">Cara Mengonfigurasi Pengaturan:</h4>
                  <Figure label="" 
                  src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777253852/roiback_setting_v1.png" />
        <p>Untuk mengubah parameter Roiback, buka tab <strong>Pengaturan</strong>. Bagian ini berisi beberapa opsi yang dapat dikonfigurasi:</p>
        <ul className="ml-6 list-disc space-y-1">
          <li>
            <strong>Aktifkan Saluran:</strong> Aktifkan opsi ini untuk mengaktifkan koneksi antara properti dan mitra.
          </li>
          <li>
            <strong>Aktifkan Pembaruan:</strong> Nyalakan opsi ini untuk mengizinkan sistem mendorong pembaruan harga, ketersediaan, dan pembatasan ke Roiback.
          </li>
          <li>
            <strong>Aktifkan Reservasi:</strong> Aktifkan opsi ini untuk menerima pemesanan dari Roiback.
          </li>
          <li>
          ...
          <li>
            <strong>Bagian Mata Uang (jika Berbeda):</strong> Pilih mata uang jika berbeda dari default sistem. Masukkan nilai konversi dan klik tombol <strong>simpan (✓)</strong> untuk menerapkan perubahan.
                    ...
                    <Figure label=""
                    src="https://res.cloudinary.com/dayo5hqig/image/upload/v1777257565/roiback_currency_v1.png" />
          <li>
        ...
        <div className="mt-4 rounded-lg border bg-muted/50 p-4">
          ...
          <dl className="mt-2 space-y-2 text-sm">
            ...
            <div>
              <dt className="font-medium">Tidak menerima reservasi dari Roiback</dt>
              <dd className="ml-4 text-muted-foreground">
                Konfirmasikan bahwa <strong>Aktifkan Reservasi</strong> diaktifkan. Pastikan rate plan dipetakan dan aktif di Roiback dan sistem.
              </dd>
            </div>
            <div>
            ...
            <div>
              <dt className="font-medium">Impor Reservasi Roiback Mendatang tidak berfungsi</dt>
              <dd className="ml-4 text-muted-foreground">
                Segarkan halaman dan klik lagi. Jika tidak ada reservasi yang diimpor, periksa dengan Roiback apakah ada pemesanan baru dan telah dikonfirmasi.
              </dd>
            </div>
            <div>
            ...
            <div>
              ...
              <dd className="ml-4 text-muted-foreground">
                Arahkan kursor ke entri pembaruan yang gagal untuk melihat pesan kesalahan. Konfirmasikan bahwa rate plan dan kamar masih aktif di extranet Roiback. Coba kirim ulang pembaruan menggunakan tombol <strong>Pembaruan OTA</strong>.
              </dd>
            </div>
          </dl>
        </div>
